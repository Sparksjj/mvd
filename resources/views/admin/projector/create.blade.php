    ...
    <div class="container"> 
        ...
        <div class="col-md-12 content-wrapper" id="main-content">
            ...
            <div class="panel-heading clearfix">
                <h4 class="">Новый проектор</h4>
            </div>

            <div class="panel-body">
        
                    <h3 class="text-center">Новый проектор</h3>

                    @include('admin.parts._formErorr')

                    <form class="" action="{{ route('projector.store') }}" method="POST" enctype="multipart/form-data" id="create-document-form">

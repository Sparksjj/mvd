        ...
        <div class="col-md-12 content-wrapper" id="main-content">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="text-center">Изменить страницу "О нас"</h4>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <form class="" action="{{ route('aboutadmin.update', $about) }}" method="POST" id="create-document-form">
                            ...
                            <div>
                                ...
                                <div class="tab-content" id="content-wrapper">
                                    <div role="tabpanel" class="tab-pane active" id="content_ru-wrapper">
                                        <textarea name="content_ru" class="form-control" id="content_ru">{{$about->content_ru}}</textarea>
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="content_en-wrapper">
                                        <textarea name="content_en" class="form-control" id="content_en">{{$about->content_en}}</textarea>
                    ...
                    <a href="{{ route('aboutadmin.show', 1) }}" class="help-href">Просмотр страницы "О нас"</a>
                </div> 
            </div>
        </div>
